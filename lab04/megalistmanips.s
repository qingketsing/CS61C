...
mapLoop:
    lw t1, 0(s0)        # load the array pointer from the node
    lw t2, 4(s0)        # load the size of the node's array into t2

    slli t3, t0, 2      # calculate byte offset (index * 4)
    add t4, t1, t3      # calculate address: base + offset (don't modify t1)
    ...
    jal  map            # recurse
    j done              # jump to done after recursion returns
